...
class WidescreenMode {
    ...
    addListener() {
        window.addEventListener('commentsLoaded', () => {
            this.bar = new __WEBPACK_IMPORTED_MODULE_0__bower_components_simplebar_dist_simplebar_js___default.a(document.getElementsByClassName('item-comments')[0]);
        });
    }
